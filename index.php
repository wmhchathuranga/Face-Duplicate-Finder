            ...
            <div class="col pb-2">
                    ...
                    <div class="card w-75">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input id="urlInput" type="url" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter image URL here ...">
                                <!-- hidden imput field -->
                ...
                <div class="d-flex justify-content-center mt-3">
                    <div class="col-9 mt-2  ">
                        ...
                        <div id="conditionalContent" class="alert alert-danger alert-dismissible fade" role="alert" id="errorAlert">
                ...
                <!-- Form two -->
                <form class="d-none justify-content-center align-items-center my-3" id="myForm2">
                    <div class="card w-75">
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="uid-tag" class="form-label fw-bold">User Id</label>
                                <input type="text" class="form-control" id="uid-tag" aria-describedby="emailHelp" placeholder="576865 ...">
                                <!-- hidden imput field -->
